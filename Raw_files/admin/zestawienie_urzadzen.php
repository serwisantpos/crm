...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Zestawienie
        <small>urządzeń</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Formularz</a></li>
        <li class="active">Zestawienie urzadzen</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Zestawienie urządzeń</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
try {
    ...
    if ($cl->connect_errno != 0) {
        ...
        if ($result = $cl->query('SELECT * FROM Magazyn')) {
            ...
            if ($number > 0) {
                if ($number > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<td>';
                        echo "<a href=\"usun_magazyn.php?id=$row[id_magazyn]\">Usuwanie</a>";
                        echo '</td>';
                        echo '<td>';
                        echo "<a href=\"edycja_magazyn.php?id=$row[id_magazyn]\">Edycja</a>";
                        echo '</td>';
                        echo '<td>';
                        echo "<a href=\"komentarz_magazyn.php?id=$row[id_magazyn]\">Komentarz</a>";
                        echo '</td>';
                        echo '</tr>';
                        echo '</tbody>';
                    }
