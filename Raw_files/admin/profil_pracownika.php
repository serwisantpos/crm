    ...
    if ($cl->connect_errno != 0) {
        ...
        if ($result = $cl->query("SELECT * FROM Pracownicy WHERE id_pracownika = '$id'")) {
            ...
            if ($number > 0) {
                ...
                echo '<a href="edycja_profil.php?id=' . $row[id_pracownika] . '" class="fa fa-edit"></i></a></div>';
                ...
                echo '<h3 class="profile-username text-center">' . $row['imie'] . ' ' . $row['nazwisko'] . '</h3>';
                ...
                <div class="tools">
                <a href="edycja_profil.php?id=$row[id_pracownika]" class="fa fa-edit"></i></a>
                </div>

                <div class="box-header text-center with-border">
                <h3 class="box-title">O pracowniku</h3>
                </div>
...
znaczni;
                ...
                <strong><i class="fa fa-map-marker margin-r-5"></i> Adres zamieszkania</strong>


                <p class="text-muted">
znaczni;

                echo $row['adres_zamieszkania'];
