...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Dodawanie nowego urządzenia</li>
      </ol>
    </section>
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">Sprzęt</label>
                ...
                <div class="form-group">
                  <label for="exampleInputPassword1">ilosc</label>
...
?>
                ...
                <div class="form-group">
                  <label for="exampleInputPassword1">TID</label>
