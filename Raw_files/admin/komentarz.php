    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="dodaj_komentarz.php" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Numer zlecenia</label>
                  <?php echo $_SESSION['numer_zlecenia']; ?>

                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Kontrahent</label>
                  <?php echo $_SESSION['nazwa_kontrahenta']; ?>
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Adres</label>
                  <?php echo $_SESSION['adres_kontrahenta']; ?>
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Kontakt</label>
                  <?php echo $_SESSION['kontakt']; ?>
                </div>
                 <!-- select -->
                 <div class="form-group">
                  <label>Typ zlecenia</label>
                  <?php echo $_SESSION['typ_zlecenia']; ?>
                </div>

                <!-- textarea -->
                <div class="form-group">
                  <label>Opis</label>
                  <?php echo $_SESSION['opis']; ?>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label>Dodaj komentarz do zlecenia</label>
                  <textarea name="komentarz" class="form-control" rows="3" placeholder="Komentarz ..."></textarea>
                </div>
           ...
           <?php
if (isset($_SESSION['blad_komentarza'])) {
    echo $_SESSION['blad_komentarza'];
    unset($_SESSION['blad_komentarza']);
}
?>       </div>
          </form>
        </div>
...
try {
    ...
    if ($cl->connect_errno != 0) {
        ...
        if ($result = $cl->query("SELECT * FROM Komentarze WHERE numer_zlecenia='$numer_zlecenia'")) {
            $number = $result->num_rows;
            if ($number > 0) {
    ...
    echo '<span style="color:red">Błąd serwera! </span>';
    echo '<br/>Indormacja developerska:' . $erro;
}
