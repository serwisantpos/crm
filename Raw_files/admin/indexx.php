...
try {
    ...
    if ($cl->connect_errno != 0) {
        ...
        if (isset($_POST['addtask'])) {
            ...
            if ($result = $cl->query("INSERT INTO todolist (id_todolist,zadanie) VALUES (NULL,'$addtask')")) {
                $udanedodawanie = true;
            }
        }
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              ...
              <h3><?php echo $suma_zlecen; ?></h3>

              <p>Wszystkie zlecenia(otwarte i zamknięte)</p>
            </div>
            <div class="icon">
              <i class="ion ion-bag"></i>
            </div>
            <a href="wszystkie_zlecenia.php" class="small-box-footer">Więcej informacji<i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3><?php echo $ilosc_pracownikow; ?></h3>

              <p>Zarejestrowanych pracowników</p>
            </div>
            <div class="icon">
              <i class="ion ion-person-add"></i>
            </div>
            <a href="Profile.php" class="small-box-footer">Więcej informacji <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h3><?php echo $suma_zlecen_zamknietych; ?></h3>

              <p>Zlecenia zamknięte</p>
            </div>
            <div class="icon">
              <i class="ion ion-pie-graph"></i>
            </div>
            <a href="zlecenia_zamkniete.php" class="small-box-footer">Więcej informacji <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3><?php
$procent = $suma_zlecen_otwartych / $suma_zlecen;
echo ($procent * 100);
?>
              <sup style="font-size: 20px">%</sup></h3>

              <p>Zrealizowane zlecenia procentowo</p>
            </div>
            <div class="icon">
              <i class="ion ion-stats-bars"></i>
            </div>
            <p href="#" class="small-box-footer"><?php if (($procent * 100) > 50) {echo "Bardzo dobry wynik";} else {echo "Słaby wynik";}?><i class="fa fa-arrow-circle-right"></i></p>
          </div>
        </div>
        <!-- ./col -->
      </div>
...
<div class="row">
  ...
  <section class="col-lg-12 connectedSortable">
    ...
    <div class="box-header">
        ...
        <h3 class="box-title">Lista rzeczy do zrobienia</h3>

        <div class="box-tools pull-right">
          <ul class="pagination pagination-sm inline">
          <li><a href="#">&laquo;</a></li>
znaczn;
        if ($result = $cl->query("SELECT * FROM todolist")) {
            $count = $result->num_rows;
            $links = ceil($count / 5);
            for ($a = 1; $a <= $links; $a++) {
                echo '<li><a href="indexx.php?page=' . $a . '">' . $a . '</a></li>';
            }
...
zna;
        ...
        if ($result = $cl->query("SELECT * FROM todolist limit $page1,5")) {
            $suma_zadan = $result->num_rows;
...
?>
            ...
            <input type="text" name="addtask" size="150" id="todo">
              <button type="submit" onclick="wyczysc()" class="btn btn-default pull-right"><i class="fa fa-plus"></i> Dodaj zadanie</button>
            </div>
            </form>
          </div>
          <!-- /.box -->
