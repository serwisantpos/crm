...
if (isset($id)) {
    try {
        ...
        if ($cl->connect_errno != 0) {
            ...
            if ($result = $cl->query("SELECT * FROM Magazyn WHERE id_magazyn = '$id'")) {
                $number = $result->num_rows;
                if ($number > 0) {
                    $row = $result->fetch_assoc();
                    $_SESSION['sprzet'] = $row['sprzet'];
                    $_SESSION['ilosc'] = $row['ilosc'];
                    $_SESSION['sn'] = $row['sn'];
...
<div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <!-- left column -->
        <form role="form" action="walidacja_dodawanie_urzadzenia.php" method="post">
        <div class="box-body">
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">Sprzęt: <?php echo $_SESSION['sprzet']; ?></label>
                  <input type="text" name="sprzet" class="form-control" id="exampleInputEmail1" placeholder="Sprzet" required>
                ...
                <div class="form-group">
                  <label for="exampleInputPassword1">ilosc: <?php echo $_SESSION['ilosc']; ?></label>
                  <input required type="number" name="ilosc" class="form-control" id="exampleInputPassword1" placeholder="ilosc">
                </div>
                <div class="form-group">
