...
<head>
  ...
  <title>Zlecenia zamknięte</title>
...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Wszystkie
        <small>zamknięte zlecenia</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Formularz</a></li>
        <li class="active">Wszystkie_zamknięte_zlecenia</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Wszystkie zamknięte zlecenia</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
try {
    ...
    if ($cl->connect_errno != 0) {
        ...
        if ($result = $cl->query("SELECT * FROM Zlecenia WHERE status='zamkniete' AND pracownik = '$email'")) {
            ...
            if ($number > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    if (isset($_SESSION['admin']) && $_SESSION['admin'] == 1) {
                        ...
                        echo '<td>';
                        echo "<a href=\"usun.php?id=$row[Numer_zlecenia]\">Usuwanie</a>";
                        echo '</td>';
